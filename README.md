...
|---|---|
| ![Login](docs/screenshots/01_login.png) | ![Dashboard](docs/screenshots/03_dashboard.png) |

| Student Management | Transcript Processing |
|---|---|
| ![Students](docs/screenshots/04_students.png) | ![Transcripts](docs/screenshots/05_transcripts.png) |

| Knowledge Base | Advisor Panel |
|---|---|
| ![Knowledge](docs/screenshots/06_knowledge.png) | ![Advisor](docs/screenshots/07_advisor_students.png) |
